...
const NewsCard = ({ image, h1, p1 }) => {
    return (
        <div className="w-full sm:w-5/12 lg:w-2/5 xl:w-[30%]">
            <img className="rounded-[1.5rem]  w-full" src={image} alt='images' />
            <div className="flex justify-between items-start my-4">
                <p className="text-2xl w-4/5 font-bold">{h1}</p>
                <p className="text-[blue] py-2 px-1 bg-[#0000ff15]">05 Sep</p>
            </div>
