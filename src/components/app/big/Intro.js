...
const Intro = () => {
    return (
        <section id="about" className="my-20">
            ...
            <p className="text-left md:text-center w-11/12 md:w-full lg:w-3/4 mx-auto md:text-xl mt-4 md:leading-loose">Cloudax will provide a platform for impact and profit-driven faith-based wholesome content businesses to earn money by enabling users have autonomy over their finances.
                Cloudax is an ever-expanding and scalable decentralised ecosystem built to power the next generation of user-friendly web3 applications and products with the goal of permeating the globe and driving blockchain adoption.
            </p>
