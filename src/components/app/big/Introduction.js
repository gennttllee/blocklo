...
const Introduction = () => {
  return (
    <section id='token info' className=" bg-gradient-to-r from-[#2F79F9] to-[#3DAEFA] rounded-[2.5rem] w-11/12 text-white p-12 mx-auto flex items-center flex-col-reverse md:flex-row justify-between my-24 gap-y-14">
